...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      "El desarrollo de software es una actividad inherentemente colaborativa que requiere una coordinación efectiva entre múltiples personas con diferentes habilidades y conocimientos. En αCentauri, hemos experimentado con diversas metodologías y prácticas para optimizar nuestro trabajo en equipo, y en este artículo queremos compartir algunas de las lecciones que hemos aprendido.",
  ...
  },
  {
    ...
    content: [
      "La robótica educativa se ha convertido en una herramienta poderosa para la formación de futuros ingenieros, combinando conceptos de mecánica, electrónica, programación y diseño en proyectos prácticos y motivadores. En αCentauri, creemos firmemente en el potencial de la robótica como vehículo para el aprendizaje, y hemos desarrollado diversas iniciativas para promover esta disciplina entre estudiantes de diferentes niveles educativos.",
